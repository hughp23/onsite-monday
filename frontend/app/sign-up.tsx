    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        <View style={styles.headerRow}>
          ...
          <Text style={styles.headerTitle}>Onsite Monday</Text>
          ...
          >
            <Text style={styles.primaryBtnText}>
              {currentSlide === 0
                ...
                : currentSlide === TOTAL_SLIDES - 2 ? 'Almost done!'
                : 'Continue'}
            </Text>
            {!isCreatingAccount && <Ionicons name="arrow-forward" size={20} color={colors.white} />}
          </TouchableOpacity>
        </View>
      )}
